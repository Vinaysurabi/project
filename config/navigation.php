<nav class="navbar navbar-default">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="../cs518/profile/view_profile.php">View Profile</a></li>
                    <li><a href="../cs518/profile/update_account.php">Update Account Details</a></li>
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="../cs518/login/logout.php"><span class="glyphicon glyphicon-log-in"></span> Logout</a></li>
        </ul>
    </div>
</nav>