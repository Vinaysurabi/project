...
<body>
    ...
    <br>
    <br>
    <form action="http://localhost/cs518/search_user_logged.php" method="get" autocomplete="on">
                    ...
                    <div class="panel panel-success">
                        <div class=panel-heading>
                            <h2 class=panel-title>
                                <a href="<?php
                                                $output = ('http://localhost/cs518/single_document_user_logged.php?id=' . $results[$i]['_id']) . '&email='  . $email;
